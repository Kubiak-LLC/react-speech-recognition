...
var useSpeechRecognition = function useSpeechRecognition() {
  ...
  var _useStaet = useStaet(recognitionManager.fullResults),
      _useStaet2 = _slicedToArray(_useStaet, 2),
      fullResults = _useStaet2[0],
      setFullResults = _useStaet2[1];
  ...
  var handleResultsChange = (0, _react.useCallback)(function (newResults) {
    dispatch(newResults);
  }, [newResults]);
  ...
  }, [transcribing, clearTranscriptOnListen, recognitionManager, handleTranscriptChange, handleResultsChange, handleClearTranscript]);
